...
import tip.capstone.mathuto.databinding.Lesson14OverviewBinding
import tip.capstone.mathuto.databinding.Lesson15OverviewBinding
import tip.capstone.mathuto.quiz.Quiz10Activity
import tip.capstone.mathuto.quiz.Quiz15Activity
import tip.capstone.mathuto.tutorial.Tutorial10Activity
import tip.capstone.mathuto.tutorial.Tutorial15Activity
import java.util.*

class OverviewFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson15OverviewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson15OverviewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnTutorial.setOnClickListener {
            val intent = Intent(requireActivity(), Tutorial15Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(requireActivity(), Quiz15Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_15_sample_1)
