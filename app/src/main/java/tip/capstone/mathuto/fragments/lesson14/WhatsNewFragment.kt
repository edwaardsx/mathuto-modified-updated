...
import tip.capstone.mathuto.databinding.Lesson14WhatsNewBinding
...
class WhatsNewFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson14WhatsNewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson14WhatsNewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_14_sample_2)
