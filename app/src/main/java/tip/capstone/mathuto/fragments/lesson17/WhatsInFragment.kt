...
import tip.capstone.mathuto.databinding.Lesson12WhatsInBinding
import tip.capstone.mathuto.databinding.Lesson17WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson17WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson17WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_17_sample_2)
