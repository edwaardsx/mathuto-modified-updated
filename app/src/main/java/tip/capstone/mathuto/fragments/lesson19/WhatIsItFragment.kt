...
import tip.capstone.mathuto.databinding.Lesson19WhatIsItBinding
import java.util.*

class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson19WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson19WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
