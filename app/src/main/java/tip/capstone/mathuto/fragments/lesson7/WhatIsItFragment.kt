...
import tip.capstone.mathuto.databinding.Lesson7WhatIsItBinding
import java.util.*

class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson7WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson7WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_7_sample_4_1)
        ...
        binding.example2.setOnClickListener {
            ...
            val viewPager: ViewPager = dialog.findViewById(R.id.view_pager)
            val images = listOf(R.drawable.lesson_7_sample_4_2)
            val adapter = FullScreenImageAdapter(requireContext(), images)
            viewPager.adapter = adapter
