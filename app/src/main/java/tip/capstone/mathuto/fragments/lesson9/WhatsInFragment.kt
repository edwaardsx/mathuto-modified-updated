...
import tip.capstone.mathuto.databinding.Lesson9WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson9WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson9WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_9_sample_2_2)
        ...
        binding.example2.setOnClickListener {
            ...
            val viewPager: ViewPager = dialog.findViewById(R.id.view_pager)
            val images = listOf(R.drawable.lesson_9_sample_2_1)
            val adapter = FullScreenImageAdapter(requireContext(), images)
            viewPager.adapter = adapter
        ...
        binding.example3.setOnClickListener {
            ...
            val viewPager: ViewPager = dialog.findViewById(R.id.view_pager)
            val images = listOf(R.drawable.lesson_9_sample_1)
            val adapter = FullScreenImageAdapter(requireContext(), images)
            viewPager.adapter = adapter
