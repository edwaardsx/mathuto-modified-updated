...
import tip.capstone.mathuto.databinding.Lesson18WhatsNewBinding
...
class WhatsNewFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson18WhatsNewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson18WhatsNewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_18_sample_2)
