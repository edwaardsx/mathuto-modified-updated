...
import tip.capstone.mathuto.databinding.Lesson5OverviewBinding
import tip.capstone.mathuto.quiz.Quiz12Activity
import tip.capstone.mathuto.quiz.Quiz5Activity
import tip.capstone.mathuto.tutorial.Tutorial12Activity
import tip.capstone.mathuto.tutorial.Tutorial5Activity
import java.util.*

class OverviewFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson12OverviewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson12OverviewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnTutorial.setOnClickListener {
            val intent = Intent(requireActivity(), Tutorial12Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(requireActivity(), Quiz12Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_12_sample_1)
