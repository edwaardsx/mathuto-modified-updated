...
import tip.capstone.mathuto.databinding.Lesson2WhatsNewBinding
...
class WhatsNewFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson5WhatsNewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson5WhatsNewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_5_sample_2)
