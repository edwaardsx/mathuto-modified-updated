...
import tip.capstone.mathuto.databinding.Lesson19WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson19WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson19WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
