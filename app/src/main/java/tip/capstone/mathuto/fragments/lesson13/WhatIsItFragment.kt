...
import tip.capstone.mathuto.databinding.Lesson13WhatIsItBinding
import java.util.*

class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson13WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson13WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_13_sample_3_1)
