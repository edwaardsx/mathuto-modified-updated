...
import tip.capstone.mathuto.databinding.Lesson11WhatIsItBinding
import java.util.*

class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson11WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson11WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_11_sample_2)
