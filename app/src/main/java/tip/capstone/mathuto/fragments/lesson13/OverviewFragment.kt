...
import tip.capstone.mathuto.databinding.Lesson13OverviewBinding
import tip.capstone.mathuto.quiz.Quiz10Activity
import tip.capstone.mathuto.quiz.Quiz13Activity
import tip.capstone.mathuto.tutorial.Tutorial10Activity
import tip.capstone.mathuto.tutorial.Tutorial13Activity
import java.util.*

class OverviewFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson13OverviewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson13OverviewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnTutorial.setOnClickListener {
            val intent = Intent(requireActivity(), Tutorial13Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(requireActivity(), Quiz13Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_13_sample_1)
