...
class OverviewFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson16OverviewBinding
    ...
    override fun onCreateView(
        ...
        binding = tip.capstone.mathuto.databinding.Lesson16OverviewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_16_sample_1)
