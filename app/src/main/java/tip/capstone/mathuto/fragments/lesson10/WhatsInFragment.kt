...
class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    override fun onCreateView(
        ...
        binding = Lesson10WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_10_sample_1)
