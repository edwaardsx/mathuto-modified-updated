...
class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson5WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson5WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_5_sample_3)
        ...
        binding.example2.setOnClickListener {
            ...
            val viewPager: ViewPager = dialog.findViewById(R.id.view_pager)
            val images = listOf(R.drawable.lesson_5_sample_3_1)
            val adapter = FullScreenImageAdapter(requireContext(), images)
            viewPager.adapter = adapter
