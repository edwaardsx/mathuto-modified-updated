...
import tip.capstone.mathuto.databinding.Lesson18WhatIsItBinding
import java.util.*

class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson18WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson18WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
