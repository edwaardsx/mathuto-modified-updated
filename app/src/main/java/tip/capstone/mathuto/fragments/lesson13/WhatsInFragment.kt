...
import tip.capstone.mathuto.databinding.Lesson13WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson13WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson13WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
