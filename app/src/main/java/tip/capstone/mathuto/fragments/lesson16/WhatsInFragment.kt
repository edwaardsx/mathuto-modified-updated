...
import tip.capstone.mathuto.databinding.Lesson16WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson16WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson16WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
