...
import tip.capstone.mathuto.databinding.Lesson18WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson18WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson18WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
