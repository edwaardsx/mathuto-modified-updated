...
import tip.capstone.mathuto.databinding.Lesson11SimulationBinding

class SimulationFragment : Fragment() {

    private lateinit var binding: Lesson11SimulationBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = Lesson11SimulationBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.simulation.setOnClickListener {
            ...
            val images = listOf(
                R.drawable.simulation_11_1, R.drawable.simulation_11_2,
                R.drawable.simulation_11_3, R.drawable.simulation_11_4, R.drawable.simulation_11_5, R.drawable.simulation_11_6,
                R.drawable.simulation_11_7, R.drawable.simulation_11_8, R.drawable.simulation_11_9, R.drawable.simulation_11_10, R.drawable.simulation_11_11)
        ...
        binding.btnWatchVideo.setOnClickListener{
            val videoUri = Uri.parse("android.resource://" + requireActivity().packageName + "/" + R.raw.simulation_11)
