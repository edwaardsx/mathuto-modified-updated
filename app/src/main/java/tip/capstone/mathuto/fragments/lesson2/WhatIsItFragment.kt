...
class WhatIsItFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson2WhatIsItBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson2WhatIsItBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_2_sample_2)
