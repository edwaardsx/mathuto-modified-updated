...
class SimulationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.simulation.setOnClickListener {
            ...
            val images = listOf(
                R.drawable.simulation_2_1, R.drawable.simulation_2_2, R.drawable.simulation_2_3,
                R.drawable.simulation_2_4, R.drawable.simulation_2_5, R.drawable.simulation_2_6)
        ...
        binding.btnWatchVideo.setOnClickListener{
            val videoUri = Uri.parse("android.resource://" + requireActivity().packageName + "/" + R.raw.simulation_2)
