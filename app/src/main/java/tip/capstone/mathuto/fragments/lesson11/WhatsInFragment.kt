...
import tip.capstone.mathuto.databinding.Lesson11WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson11WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson11WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
