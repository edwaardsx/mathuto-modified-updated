...
import tip.capstone.mathuto.databinding.Lesson3WhatsInBinding
import java.util.*

class WhatsInFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson3WhatsInBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson3WhatsInBinding.inflate(inflater, container, false)
        return binding.root
    }
