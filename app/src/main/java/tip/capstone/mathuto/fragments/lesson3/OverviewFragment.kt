...
class OverviewFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    private lateinit var binding: Lesson3OverviewBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnTutorial.setOnClickListener {
            val intent = Intent(requireActivity(), Tutorial3Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(requireActivity(), Quiz3Activity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            requireActivity().startActivity(intent)
        }
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_3_sample_1)
