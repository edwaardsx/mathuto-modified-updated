...
import tip.capstone.mathuto.databinding.Lesson19WhatsNewBinding
import tip.capstone.mathuto.databinding.Lesson8WhatsNewBinding
import java.util.*

class WhatsNewFragment : Fragment(), TextToSpeech.OnInitListener {

    private lateinit var binding: Lesson19WhatsNewBinding
    ...
    override fun onCreateView(
        ...
        binding = Lesson19WhatsNewBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.example1.setOnClickListener {
            ...
            val images = listOf(R.drawable.lesson_19_sample_2)
        ...
        binding.example1.setOnClickListener {
            ...
            val viewPager: ViewPager = dialog.findViewById(R.id.view_pager)
            val images = listOf(R.drawable.lesson_8_sample_3_1)
            val adapter = FullScreenImageAdapter(requireContext(), images)
            viewPager.adapter = adapter
