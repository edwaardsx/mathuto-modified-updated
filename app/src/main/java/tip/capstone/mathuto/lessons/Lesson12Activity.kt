...
import tip.capstone.mathuto.adapter.Lesson12TabAdapter
import tip.capstone.mathuto.databinding.Lesson12Binding
...
class Lesson12Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson12Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson12Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson12TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_12)
