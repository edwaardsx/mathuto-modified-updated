...
import tip.capstone.mathuto.adapter.Lesson14TabAdapter
import tip.capstone.mathuto.databinding.Lesson14Binding
...
class Lesson14Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson14Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson14Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson14TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_14)
