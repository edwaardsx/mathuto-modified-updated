...
class Lesson4Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tabAdapter = Lesson4TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_4)
