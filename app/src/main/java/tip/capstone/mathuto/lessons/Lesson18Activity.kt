...
import tip.capstone.mathuto.adapter.Lesson18TabAdapter
import tip.capstone.mathuto.databinding.Lesson18Binding
...
class Lesson18Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson18Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson18Binding.inflate(layoutInflater)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_18)
