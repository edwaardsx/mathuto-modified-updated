...
import tip.capstone.mathuto.adapter.Lesson10TabAdapter
import tip.capstone.mathuto.databinding.Lesson10Binding
...
class Lesson10Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson10Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson10Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson10TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_10)
