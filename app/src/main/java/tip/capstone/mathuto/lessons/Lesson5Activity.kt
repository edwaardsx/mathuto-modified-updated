...
import tip.capstone.mathuto.adapter.Lesson5TabAdapter
import tip.capstone.mathuto.databinding.Lesson5Binding
...
class Lesson5Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson5Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson5Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson5TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_5)
