...
class Lesson2Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson2Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson2Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson2TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_2)
