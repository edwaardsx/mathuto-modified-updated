...
import tip.capstone.mathuto.adapter.Lesson3TabAdapter
import tip.capstone.mathuto.databinding.Lesson3Binding
...
class Lesson3Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson3Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson3Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson3TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_3)
