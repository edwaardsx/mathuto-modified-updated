...
import tip.capstone.mathuto.adapter.Lesson8TabAdapter
import tip.capstone.mathuto.databinding.Lesson8Binding
...
class Lesson8Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson8Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson8Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson8TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_8)
