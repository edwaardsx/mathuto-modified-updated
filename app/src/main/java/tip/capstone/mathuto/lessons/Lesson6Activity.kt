...
import tip.capstone.mathuto.adapter.Lesson6TabAdapter
import tip.capstone.mathuto.databinding.Lesson6Binding
...
class Lesson6Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson6Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson6Binding.inflate(layoutInflater)
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("What New"))
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("Simulation"))

        val tabAdapter = Lesson6TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_6)
