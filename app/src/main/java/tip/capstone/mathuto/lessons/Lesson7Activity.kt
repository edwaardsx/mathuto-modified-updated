...
import tip.capstone.mathuto.adapter.Lesson7TabAdapter
import tip.capstone.mathuto.databinding.Lesson7Binding
...
class Lesson7Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson7Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson7Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson7TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_7)
