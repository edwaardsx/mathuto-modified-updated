...
import tip.capstone.mathuto.adapter.Lesson11TabAdapter
import tip.capstone.mathuto.databinding.Lesson11Binding
...
class Lesson11Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson11Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson11Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson11TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_11)
