...
import tip.capstone.mathuto.adapter.Lesson16TabAdapter
import tip.capstone.mathuto.databinding.Lesson16Binding
...
class Lesson16Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson16Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson16Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson16TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_16)
