...
import tip.capstone.mathuto.adapter.Lesson9TabAdapter
import tip.capstone.mathuto.databinding.Lesson9Binding
...
class Lesson9Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson9Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson9Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson9TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_9)
