...
import tip.capstone.mathuto.adapter.Lesson17TabAdapter
import tip.capstone.mathuto.databinding.Lesson17Binding
...
class Lesson17Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson17Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson17Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson17TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_17)
