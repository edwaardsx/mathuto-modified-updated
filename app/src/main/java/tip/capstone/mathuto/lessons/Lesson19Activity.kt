...
import tip.capstone.mathuto.adapter.Lesson19TabAdapter
import tip.capstone.mathuto.databinding.Lesson19Binding
...
class Lesson19Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Lesson19Binding
    private lateinit var db: SQLiteHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Lesson19Binding.inflate(layoutInflater)
        ...
        val tabAdapter = Lesson19TabAdapter(supportFragmentManager, binding.tabLayout.tabCount)
    ...
    private fun showObjectives() {
        ...
        dialog.setContentView(R.layout.objectives_19)
