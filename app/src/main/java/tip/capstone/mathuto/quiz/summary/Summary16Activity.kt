...
import tip.capstone.mathuto.databinding.QuizSummary16Binding
...
class Summary16Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary16Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question16.SELECTED_ANSWERS)
