...
import tip.capstone.mathuto.databinding.Quiz10Binding
...
import tip.capstone.mathuto.quiz.result.Result10Activity
...
class Quiz10Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz10Binding.inflate(layoutInflater)
        ...
        mMultipleChoiceList = Question10.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result10Activity::class.java)
