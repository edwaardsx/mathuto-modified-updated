...
import tip.capstone.mathuto.databinding.QuizSummary12Binding
...
class Summary12Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary12Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary12Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question12.SELECTED_ANSWERS)
