...
import tip.capstone.mathuto.databinding.QuizSummary18Binding
...
class Summary18Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary18Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question18.SELECTED_ANSWERS)
