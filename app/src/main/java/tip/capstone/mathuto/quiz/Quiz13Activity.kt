...
import tip.capstone.mathuto.questions.Question13
...
import tip.capstone.mathuto.quiz.result.Result13Activity
...
class Quiz13Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz13Binding.inflate(layoutInflater)
        ...
        mMultipleChoiceList = Question13.getQuestions()
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                ...
                if(scores.size < 13){
                    ...
                    if (mCorrectAnswers > Integer.parseInt(scores[12].score)) {
