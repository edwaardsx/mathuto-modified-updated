...
import tip.capstone.mathuto.databinding.QuizResult9Binding
import tip.capstone.mathuto.lessons.Lesson9Activity
import tip.capstone.mathuto.questions.Question9.CORRECT_ANS
import tip.capstone.mathuto.questions.Question9.SELECTED_ANSWERS
import tip.capstone.mathuto.questions.Question9.TOTAL_QUESTIONS
import tip.capstone.mathuto.questions.Question9.WRONG_ANS
import tip.capstone.mathuto.quiz.summary.Summary9Activity


class Result9Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult9Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult9Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson9Activity::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  Summary9Activity::class.java)
    ...
    private fun unLockNextLesson10() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_10)
