...
import tip.capstone.mathuto.databinding.Quiz6Binding
...
import tip.capstone.mathuto.quiz.result.Result6Activity
...
class Quiz6Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz6Binding.inflate(layoutInflater)
        ...
        mTrueOrFalseList = Question6.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mTrueOrFalseList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result6Activity::class.java)
                ...
                if(scores.size < 6){
                    ...
                    if (mCorrectAnswers > Integer.parseInt(scores[5].score)) {
                        ...
                        if (mCorrectAnswers > highestScore) {
                            db.updateHighScores("Lesson 6", mCorrectAnswers.toString())
                        }
                    }
                }
