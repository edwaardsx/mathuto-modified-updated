...
import tip.capstone.mathuto.databinding.QuizSummary9Binding
...
class Summary9Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary9Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question9.SELECTED_ANSWERS)
