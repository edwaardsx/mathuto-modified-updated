...
class Quiz15Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz15Binding.inflate(layoutInflater)
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                ...
                if(scores.size < 15){
                    ...
                    if (mCorrectAnswers > Integer.parseInt(scores[14].score)) {
