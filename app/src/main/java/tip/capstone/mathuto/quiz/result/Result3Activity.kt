...
class Result3Activity : AppCompatActivity() {
    ...
    private lateinit var binding: QuizResult3Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult3Binding.inflate(layoutInflater)
    ...
    private fun unLockNextLesson4() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_4)
