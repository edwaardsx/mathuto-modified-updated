...
class Result18Activity : AppCompatActivity() {
    ...
    private lateinit var binding: QuizResult18Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult18Binding.inflate(layoutInflater)
    ...
    private fun unLockNextLesson19() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_19)
