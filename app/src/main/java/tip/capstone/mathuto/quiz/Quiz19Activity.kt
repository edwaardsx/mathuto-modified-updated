...
import tip.capstone.mathuto.databinding.Quiz19Binding
...
import tip.capstone.mathuto.quiz.result.Result19Activity
...
class Quiz19Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz19Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz19Binding.inflate(layoutInflater)
        ...
        mTrueOrFalseList = Question19.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mTrueOrFalseList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                ...
                if(scores.size < 19){
                    db.insertHighScores("Lesson 19", mCorrectAnswers.toString())
                }else{
                    if (mCorrectAnswers > Integer.parseInt(scores[18].score)) {
                        ...
                        if (mCorrectAnswers > highestScore) {
                            db.updateHighScores("Lesson 19", mCorrectAnswers.toString())
                        }
                    }
                }
