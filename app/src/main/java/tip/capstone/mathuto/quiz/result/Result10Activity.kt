...
import tip.capstone.mathuto.databinding.QuizResult10Binding
import tip.capstone.mathuto.lessons.Lesson10Activity
import tip.capstone.mathuto.questions.Question10.CORRECT_ANS
import tip.capstone.mathuto.questions.Question10.SELECTED_ANSWERS
import tip.capstone.mathuto.questions.Question10.TOTAL_QUESTIONS
import tip.capstone.mathuto.questions.Question10.WRONG_ANS
import tip.capstone.mathuto.quiz.summary.Summary10Activity

class Result10Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson10Activity::class.java)
    ...
    private fun unLockNextLesson11() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_11)
