...
import tip.capstone.mathuto.databinding.QuizSummary13Binding
...
class Summary13Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary13Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question13.SELECTED_ANSWERS)
