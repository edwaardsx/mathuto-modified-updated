...
class Result2Activity : AppCompatActivity() {
    ...
    private lateinit var binding: QuizResult2Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult2Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson2Activity::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  Summary2Activity::class.java)
    ...
    private fun unLockNextLesson3() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_3)
