...
class Summary2Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary2Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question2.SELECTED_ANSWERS)
