...
import tip.capstone.mathuto.databinding.QuizSummary17Binding
...
class Summary17Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary17Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question17.SELECTED_ANSWERS)
