...
import tip.capstone.mathuto.databinding.QuizSummary7Binding
...
class Summary7Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary7Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question7.SELECTED_ANSWERS)
