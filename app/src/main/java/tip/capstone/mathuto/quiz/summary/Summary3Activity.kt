...
import tip.capstone.mathuto.databinding.QuizSummary3Binding
...
class Summary3Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary3Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question3.SELECTED_ANSWERS)
