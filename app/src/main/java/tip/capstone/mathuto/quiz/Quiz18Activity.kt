...
import tip.capstone.mathuto.databinding.Quiz18Binding
import tip.capstone.mathuto.questions.Question18
...
import tip.capstone.mathuto.quiz.result.Result18Activity
...
class Quiz18Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz18Binding.inflate(layoutInflater)
        ...
        mMultipleChoiceList = Question18.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result18Activity::class.java)
                ...
                if(scores.size < 18){
                    ...
                    if (mCorrectAnswers > Integer.parseInt(scores[17].score)) {
                        ...
                        if (mCorrectAnswers > highestScore) {
                            db.updateHighScores("Lesson 18", mCorrectAnswers.toString())
                        }
                    }
                }
