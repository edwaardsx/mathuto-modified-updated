...
import tip.capstone.mathuto.databinding.QuizResult14Binding
import tip.capstone.mathuto.lessons.Lesson14Activity
...
import tip.capstone.mathuto.quiz.summary.Summary14Activity


class Result14Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult14Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult14Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson14Activity::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  Summary14Activity::class.java)
    ...
    private fun unLockNextLesson15() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_15)
