...
import tip.capstone.mathuto.databinding.QuizResult12Binding
import tip.capstone.mathuto.lessons.Lesson12Activity
import tip.capstone.mathuto.questions.Question12.CORRECT_ANS
import tip.capstone.mathuto.questions.Question12.SELECTED_ANSWERS
import tip.capstone.mathuto.questions.Question12.TOTAL_QUESTIONS
import tip.capstone.mathuto.questions.Question12.WRONG_ANS
import tip.capstone.mathuto.quiz.summary.Summary12Activity


class Result12Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult12Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult12Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson12Activity::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  Summary12Activity::class.java)
    ...
    private fun unLockNextLesson13() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_13)
