...
import tip.capstone.mathuto.databinding.QuizResult16Binding
import tip.capstone.mathuto.lessons.Lesson16Activity
...
import tip.capstone.mathuto.quiz.summary.Summary16Activity


class Result16Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult16Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult16Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson16Activity::class.java)
    ...
    private fun unLockNextLesson17() {
        ...
        dialog.setContentView(R.layout.unlock_17)
