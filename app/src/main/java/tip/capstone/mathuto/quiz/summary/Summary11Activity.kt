...
import tip.capstone.mathuto.databinding.QuizSummary11Binding
...
class Summary11Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary11Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question11.SELECTED_ANSWERS)
