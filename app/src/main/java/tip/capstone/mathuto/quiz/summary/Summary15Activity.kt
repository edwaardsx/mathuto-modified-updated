...
import tip.capstone.mathuto.databinding.QuizSummary15Binding
...
class Summary15Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary15Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question15.SELECTED_ANSWERS)
