...
import tip.capstone.mathuto.databinding.Quiz12Binding
import tip.capstone.mathuto.questions.Question12
...
import tip.capstone.mathuto.quiz.result.Result12Activity
...
class Quiz12Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz12Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz12Binding.inflate(layoutInflater)
        ...
        mMultipleChoiceList = Question12.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result12Activity::class.java)
