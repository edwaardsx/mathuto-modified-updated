...
import tip.capstone.mathuto.databinding.Quiz8Binding
...
import tip.capstone.mathuto.quiz.result.Result8Activity
...
class Quiz8Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mMultipleChoiceList = Question8.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result8Activity::class.java)
