...
import tip.capstone.mathuto.databinding.QuizSummary5Binding
...
class Summary5Activity : AppCompatActivity() {

    private lateinit var binding: QuizSummary5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizSummary5Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = intent.getIntegerArrayListExtra(Question5.SELECTED_ANSWERS)
