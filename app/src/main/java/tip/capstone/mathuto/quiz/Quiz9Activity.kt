...
import tip.capstone.mathuto.databinding.Quiz9Binding
import tip.capstone.mathuto.questions.Question9
...
import tip.capstone.mathuto.quiz.result.Result9Activity
...
class Quiz9Activity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: Quiz9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Quiz9Binding.inflate(layoutInflater)
        ...
        mMultipleChoiceList = Question9.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mMultipleChoiceList!!.size || mCurrentPosition >= mMaxQuestions) {
            handler.postDelayed({
                val intent = Intent(applicationContext, Result9Activity::class.java)
                ...
                if(scores.size < 9){
                    ...
                    if (mCorrectAnswers > Integer.parseInt(scores[8].score)) {
