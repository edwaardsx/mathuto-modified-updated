...
import tip.capstone.mathuto.databinding.QuizResult5Binding
import tip.capstone.mathuto.lessons.Lesson5Activity
...
import tip.capstone.mathuto.quiz.summary.Summary5Activity


class Result5Activity : AppCompatActivity() {

    private lateinit var binding: QuizResult5Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = QuizResult5Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson5Activity::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  Summary5Activity::class.java)
    ...
    private fun unLockNextLesson5() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.unlock_5)
